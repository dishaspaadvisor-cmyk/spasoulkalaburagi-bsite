...
const Contact = () => {
  ...
  const handleWhatsApp = () => {
    const message = `Hi! I'm interested in booking an appointment at Spa Soul Kalaburagi. Can you please provide more details?`;
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Tell us about your Massage goals..."
                  ></textarea>
                </div>
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-primary to-accent hover:from-accent hover:to-primary text-white font-medium py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                >
                  Send Message
                </button>
              </form>
        ...
        <div className="container-custom">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            <iframe 
              ...
              title="Spa Soul Kalaburagi Location"
              className="w-full"
            ></iframe>
          </div>
        </div>
